...
/**
 * The dialog shown to the user when he wants to save the configuration.
 */
export default class extends React.Component {
     ...
     */
    ok() {
        actions.saveConfig(this.props.config, this.state.filename);
        actions.setDialogVisibility("saveConfig", false);
    }
        ...
        return (
            <Modal show={this.props.visible} onHide={() => this.cancel()}>
                <Modal.Header closeButton>
                    <Modal.Title>Save Config</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <form>
